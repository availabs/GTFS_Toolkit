...
var theAPI = {
    ...
    getDirectionIDForTrip : function (tripKey) {
        return _.get(this, ['indexedScheduleData', 'trips', tripKey, 'direction_id'], null);
    },
    ...
    getIDOfFirstStopForTrip : function (tripKey) {
        ...
        return _.get(this, ['indexedSpatialData', 'stopProjectionsTable', i, '__originStopID', 'stop_id'], null);
    },

...
var theAPI = {
    ...
    getStopTimesBySequenceForStopForTrip : function (tripKey, stop_id, stop_sequence)  {
        var stopTimesBySequence =  _.get(this, ['indexedScheduleData', 'stop_times', tripKey, stop_id], null),
            sequencesForStop ;

        if ((stopTimesBySequence === null) || (typeof stopTimesBySequence !== 'object')) {
            return null;
        }

        if ((stop_sequence === undefined) || (stop_sequence === null)) {
            sequencesForStop = Object.keys(stopTimesBySequence) ;
        ...
        return stopTimesBySequence[stop_sequence] || null;
    },

...
var theAPI = {
    ...
    getStopDistanceAlongRouteForTripInMeters : function (tripKey, stop_id) {
        ...
        return (!isNaN(d)) ? (d * 1000).toFixed(NUM_DECIMAL_DIGITS) : null;
    },
    ...
    getSequenceNumbersForStopForTrip : function (tripKey, stop_id) {
        var seqNumbers = _.get(this, 
                               ['indexedScheduleData', 'stop_times', tripKey, 'stopIdToSequenceNumbersTable', stop_id], 
                               null);
